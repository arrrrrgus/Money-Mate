...
> = {
  ...
  meta: {
    modelProps:
      'user' | 'category' | 'transaction' | 'saving' | 'supportTicket';
    ...
    Saving: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.SavingCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type SavingScalarFieldEnum =
  (typeof SavingScalarFieldEnum)[keyof typeof SavingScalarFieldEnum];
